...
public class Player extends Character {
    ...
    public Player(int xInMap, int yInMap) {
        super(Images.boomer_down[type.ordinal()][0].getImage(), xInMap, yInMap, PLAYER,
                Images.boomer_up[type.ordinal()], Images.boomer_down[type.ordinal()],
                Images.boomer_right[type.ordinal()], Images.boomer_left[type.ordinal()]);
    }
